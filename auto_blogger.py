...
def generate_blog_content():
    ...
    [썸네일 문구 및 프롬프트]:
    - 메인 타이틀: (핵심 키워드 중심의 직관적인 텍스트, 예: 목 디스크 초기증상 10)
    - 서브 타이틀: (경고 또는 유용한 정보 알림 문구, 예: 목과 팔이 보내는 경고 신호!)
    - 이미지 생성 프롬프트: (밝고 깨끗한 헬스케어 이미지 배경에 중앙/하단에 선명한 한국어 텍스트 레이아웃이 적용된 고품질 썸네일 생성을 위한 영문 프롬프트 작성)
    """
